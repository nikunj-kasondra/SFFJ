...
//  Sainte Famillie
//
//  Created by Rujal on 3/7/18.
//  Copyright © 2018 Nikunj. All rights reserved.
//

import UIKit

class AdmissionsVC: UIViewController {
    ...
    func callPresentation() {
        if !Reachability.isConnectedToNetwork() {
            ...
            let url = URL(string: "http://api.sainte-famille.edu.lb/api/sections/getinscriptions")
    ...
    @IBAction func btnVoirPlus(_ sender: Any) {
         UIApplication.shared.openURL(URL(string: "http://sainte-famille.edu.lb/SectionContent/11/Inscriptions")!)
    }
}
extension AdmissionsVC:UIWebViewDelegate {
