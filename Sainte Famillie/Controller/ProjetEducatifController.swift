//
//  ProjetEducatifController.swift
//  Sainte Famillie
//
...
class ProjetEducatifController: UIViewController {
    ...
    func callProjetEducate() {
        if !Reachability.isConnectedToNetwork() {
            Alert.show("Sainte Famillie", message: "Please check your internet connection", onVC: self)
        } else {
            Progress.show(toView: self.view)
            let url = URL(string: "http://api.sainte-famille.edu.lb/api/notrecollege/getprojeteducatif")
...
extension ProjetEducatifController:UIWebViewDelegate {
