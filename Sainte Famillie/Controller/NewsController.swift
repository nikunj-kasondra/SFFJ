...
class NewsController: UIViewController {
    ...
    func callNewsAPI() {
        if !Reachability.isConnectedToNetwork() {
            ...
            let url = URL(string: "http://api.sainte-famille.edu.lb/api/pagedacceuil/getnouvellesducollege")
    ...
    @IBAction func btnVoirClicked(_ sender: Any) {
        UIApplication.shared.openURL(URL(string: "http://www.sainte-famille.edu.lb/Nouvelles/112/0")!)
    }
    
}

extension NewsController:UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let imageStr = String("http://sainte-famille.edu.lb/Upfiles/Photos/Small/") + String((self.newsArr.value(forKey: "Thumb") as! NSArray).object(at: indexPath.row) as! String)
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let VC = Common.storyboard.instantiateViewController(withIdentifier: "NewsDetailController")
