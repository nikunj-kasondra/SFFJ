//
//  ProdProfDetailController.swift
//  Sainte Famillie
//
...
class ProdProfDetailController: UIViewController {

    @IBOutlet weak var lblHeader: UILabel!
    @IBOutlet weak var webView: UIWebView!
    var sectionName = String()
    var htmlStr = String()
    static var profId = NSNumber()
    var prodArr = NSArray()
    ...
    func callProdAPI() {
        if !Reachability.isConnectedToNetwork() {
            ...
            let url = URL(string: "http://api.sainte-famille.edu.lb/api/pagedacceuil/getproductionsdesprofsprofessorsproductions?professorsId=\(ProdProfDetailController.profId)")
...
extension ProdProfDetailController: UIWebViewDelegate {
