...
class OrganigrammeController: UIViewController {
    ...
    func callOrganigramme() {
        if !Reachability.isConnectedToNetwork() {
            Alert.show("Sainte Famillie", message: "Please check your internet connection", onVC: self)
        } else {
            Progress.show(toView: self.view)
            let url = URL(string: "http://api.sainte-famille.edu.lb/api/notrecollege/getorganigramme")
                    ...
                    do{
                        ...
                        if self.presArr.count != 0 {
                            ...
                            if htmlStr != "" {
                                ...
                                let url = URL(string: "http://advocatekishorlambat.info/organigramme%202.jpg")
...
extension OrganigrammeController:UIWebViewDelegate {
