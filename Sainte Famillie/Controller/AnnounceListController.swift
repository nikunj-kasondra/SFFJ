...
class AnnounceListController: UIViewController {
    ...
    func callEnvoyer() {
        if !Reachability.isConnectedToNetwork() {
            ...
            let url = "http://api.sainte-famille.edu.lb/api/login/getteacherannouncements?materialId=\(MatricesController.serCode)"
...
extension AnnounceListController: UITableViewDelegate,UITableViewDataSource {
