//
//  CongrationDetailController.swift
//  Sainte Famillie
//
...
class CongrationDetailController: UIViewController {
    ...
    func callCongration() {
        if !Reachability.isConnectedToNetwork() {
            ...
            let url = URL(string: "http://api.sainte-famille.edu.lb/api/notrecollege/getcongregation")
...
extension CongrationDetailController:UIWebViewDelegate {
