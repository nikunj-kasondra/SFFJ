...
class JouniehDetailController: UIViewController {
    ...
    func callJounieh() {
        if !Reachability.isConnectedToNetwork() {
            ...
            let url = URL(string: "http://api.sainte-famille.edu.lb/api/notrecollege/getjounieh")
...
extension JouniehDetailController:UIWebViewDelegate {
