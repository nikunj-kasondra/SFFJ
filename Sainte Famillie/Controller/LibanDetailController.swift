...
class LibanDetailController: UIViewController {
    ...
    func callLiban() {
        if !Reachability.isConnectedToNetwork() {
            ...
            let url = URL(string: "http://api.sainte-famille.edu.lb/api/notrecollege/getliban")
...
extension LibanDetailController:UIWebViewDelegate {
