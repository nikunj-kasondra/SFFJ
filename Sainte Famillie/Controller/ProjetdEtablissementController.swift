//
//  ProjetdEtablissementController.swift
//  Sainte Famillie
//
...
class ProjetdEtablissementController: UIViewController {
    ...
    func callProjetdEtablissement() {
        if !Reachability.isConnectedToNetwork() {
            Alert.show("Sainte Famillie", message: "Please check your internet connection", onVC: self)
        } else {
            Progress.show(toView: self.view)
            let url = URL(string: "http://api.sainte-famille.edu.lb/api/notrecollege/getprojetetablissement")
...
extension ProjetdEtablissementController:UIWebViewDelegate {
