...
class AddAgendaController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        lblId.text = AddAgendaController.id
        let date = Date()
        ...
        checkMarkArr.add(AddAgendaController.code)
    ...
    func callEnvoyer() {
        ...
        if !Reachability.isConnectedToNetwork() {
            ...
            let url = "http://api.sainte-famille.edu.lb/api/login/getteacherinsertedagenda?materialId=\(tmpStr)&subject=\(txtSubject.text!)&details=\(txtDetail.text!)"
            ...
            URLSession.shared.dataTask(with: url1!, completionHandler: {
                ...
                if(error != nil){
                    ...
                    do{
                        ...
                        let VC = Common.storyboard.instantiateViewController(withIdentifier: "AgendaListController")
...
extension AddAgendaController: UITextFieldDelegate {
...
extension AddAgendaController:UITableViewDelegate,UITableViewDataSource {
...
extension AddAgendaController:UITextViewDelegate {
